                                    ...
                                    <a href="#" class="m-nav__link m-dropdown__toggle">
												<span class="m-topbar__userpic">
													@if(Session::get('profile_img'))
                                                        <img src="{{url('storage/app/Users/profile/')}}/{{ Session::get('profile_img')}}"
                                    ...
                                    <div class="m-dropdown__wrapper">
                                        ...
                                        <div class="m-dropdown__inner">
                                            <div class="m-dropdown__header m--align-center"
                                                 style="background: url({{url('/img/user_profile_bg.jpg')}}); background-size: cover;">
                                                ...
                                                <div class="m-dropdown__content">
                                                    <ul class="m-nav m-nav--skin-light">
                                                        ...
                                                        @if(Auth::user()->isAdmin)
                                                            <li class="m-nav__item">
                                                                <a href="{{route('skills.index')}}" class="m-nav__link">Manage
                                                                    Skills</a>
                                                            </li>
                                                            <li class="m-nav__item">
                                                                <a data-toggle="modal" href="javascript:;"
                                                                   data-target="#changePassword" class="m-nav__link">
