        ...
        <div class="row">
            <div class="col-md-6">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{route('candidates.update_data_education')}}"><button id="ajaxSubmit" type="button" class="btn btn-danger" data-dismiss="modal">Close</button></a> 
                    </div>
            </div>
       @if(isset($data))
       <div class="col-md-6">
                        ...
                        <span id="form_output"></span>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Period</label>
                                        <input style="background-color: #f2f3f8;border: none;" type="text" name="" id="work_period" class="form-control" placeholder="Enter Your Last name" value="{{$subdata->education_period}}">
