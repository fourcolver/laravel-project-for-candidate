            ...
            <div class="d-flex align-items-center">
              <div class="mr-auto">
                <h3 class="m-page-title ">
                  Edit Kunden / <a href="{{ url('/admin/ad_accounts/view/'.$data->id)}}">{{$data->account_name}}</a>
                </h3>
              </div>
            </div>  
          </div>
          <div class="m-portlet m-portlet--rounded view_block">
            <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" id="editAccount" name="editAccount">
          {{ csrf_field() }}
          <div class="m-portlet__body">
            <div class="form-group m-form__group row">
              <div class="col-lg-4">
                ...
                <input type="text" value="{{$data->account_name}}" name="account_name" id="account_name" class="form-control m-input" placeholder="Enter Kunden_name Minimum 3 characters">
                  <div class="error_msg">
              ...
              <div class="col-lg-4">
                  ...
                  <select class="custom-select" id="prozesse" name="prozesse">
                    ...
                    <option value="Telefon Interview" @if($data->prozesse == 'Telefon Interview') {{ 'selected' }} @endif>Telefon Interview</option>
                    <option value="Telefon Interview und Vor-Ort Gespräch" @if($data->prozesse == 'Telefon Interview und Vor-Ort Gespräch') {{ 'selected' }} @endif>Telefon Interview und Vor-Ort Gespräch</option>
                    <option value="Vor-Ort Gespräch" @if($data->prozesse == 'Vor-Ort Gespräch') {{ 'selected' }} @endif>Vor-Ort Gespräch</option>
                    <option value="Testaufgabe" @if($data->prozesse == 'Testaufgabe') {{ 'selected' }} @endif>Testaufgabe</option>
                    <option value="NSI" @if($data->prozesse == 'NSI') {{ 'selected' }} @endif>NSI</option>
                    <option value="Embedded" @if($data->prozesse == 'Embedded') {{ 'selected' }} @endif>Embedded</option>
                  </select>
                  <div class="error_msg">
              ...
              <div class="col-lg-4">
                  ...
                  <input type="text" value="{{$data->pincode}}" name="pincode" id="pincode" class="form-control m-input" placeholder="Enter Your Job Title">
                  <div class="error_msg">
              ...
              <div class="form-group m-form__group row">
                ...
                <div class="col-lg-4">
                  ...
                  <select multiple="multiple" class="custom-select" id="Technology" name="Technology[]" style="height: 99px; width: 100%;">
                    <option value="Microsoft .Net" @if(in_array("Microsoft .Net", $technology)) {{ 'selected' }} @endif>Microsoft .Net</option>
                    <option value="Java" @if(in_array("Java", $technology)) {{ 'selected' }} @endif>Java</option>
                    <option value="SAP" @if(in_array("SAP", $technology)) {{ 'selected' }} @endif>SAP</option>
                    <option value="PHP" @if(in_array("PHP", $technology)) {{ 'selected' }} @endif>PHP</option>
                    <option value="NSI" @if(in_array("NSI", $technology)) {{ 'selected' }} @endif>NSI</option>
                    <option value="Embedded" @if(in_array("Embedded", $technology)) {{ 'selected' }} @endif>Embedded</option>
                  </select>
                  <div class="error_msg">
                ...
                <div class="col-lg-4">
                  ...
                  <select class="custom-select" name="owner" id="owner">
                    <option value="">
                    Select Owner of Account</option>
                ...
                <div class="col-lg-4">
                  ...
                  <select class="custom-select" id="client_specification" name="client_specification">
                    ...
                    <option value="1" @if($data->client_specification == '1') {{ 'selected' }} @endif>1</option>
                    <option value="2" @if($data->client_specification == '2') {{ 'selected' }} @endif>2</option>
                    <option value="3" @if($data->client_specification == '3') {{ 'selected' }} @endif>3</option>
                    <option value="4" @if($data->client_specification == '4') {{ 'selected' }} @endif>4</option>
                    <option value="5" @if($data->client_specification == '5') {{ 'selected' }} @endif>5</option>
                    <option value="6" @if($data->client_specification == '6') {{ 'selected' }} @endif>6</option>
                    <option value="7" @if($data->client_specification == '7') {{ 'selected' }} @endif>7</option>
                    <option value="8" @if($data->client_specification == '8') {{ 'selected' }} @endif>8</option>
                    <option value="9" @if($data->client_specification == '9') {{ 'selected' }} @endif>9</option>
                    <option value="10" @if($data->client_specification == '10') {{ 'selected' }} @endif>10</option>
                  </select>
                  <div class="error_msg">
              ...
              <div class="form-group m-form__group row">                
                ...
                <div class="col-lg-4">
                  ...
                  <input type="text" value="{{$data->telephone}}" name="telephone" id="telephone" class="form-control m-input" placeholder="Enter Your Telephone Number Only Numeric">
                  <div class="error_msg">
                ...
                <div class="col-lg-4">
                  ...
                  <input type="text" value="{{$data->departement_size}}" name="departement_size" id="departement_size" class="form-control m-input" placeholder="Enter Your Departement Size">
                  <div class="error_msg">
              ...
              <div class="form-group m-form__group row">
                <div class="col-lg-4">
                  ...
                  <select class="custom-select" id="type_of_client" name="type_of_client">
                    <option value="">
                    Please Select Type of Client</option>
                    <option value="Customer" @if($data->type_of_client == 'Customer') {{ 'selected' }} @endif>Customer</option>
                    <option value="Previous Customer" @if($data->type_of_client == 'Previous Customer') {{ 'selected' }} @endif>Previous Customer</option>
                    <option value="Potential Customer" @if($data->type_of_client == 'Potential Customer') {{ 'selected' }} @endif>Potential Customer</option>
                  </select>
              ...
              <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                <div class="m-form__actions m-form__actions--solid">
                  <div class="row">
                    ...
                    <div class="col-lg-8">
                      <button type="submit" id="m_edit_account" name="m_edit_account" class="btn btn-primary">
                        Submit
                      </button>
                      <a class="btn btn-secondary" href="{{ url('/admin/ad_accounts/view/'.$data->id) }}">
                        Cancel
                      </a>
                    </div>
                  </div>
                ...
                success: function(response, status, xhr, $form) {
                  ...
                  var res = $.parseJSON(response);
                    if(res.status == 'error'){
                      ...
                      setTimeout(function() {
                        window.location.replace('../../../admin/ad_accounts');
                        }, 2000);
                    }
                },
                error: function(data){
