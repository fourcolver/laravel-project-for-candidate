...
@section('content')
        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
            <div id="navigation_next">
                <div id="previous">
                    ...
                    @else
                        <a href="{{url('admin/accounts/view/'.$previous->id.'/'.$list)}}"
                           class="btn btn-outline-accent m-btn m-btn--icon btn-lg m-btn--icon-only m-btn--pill m-btn--air"><i
                                    class="fa fa-angle-left"></i></a>
                ...
                <div id="next">
                    ...
                    @else
                        <span style="color: #aaa;margin: 9px -163px;position: absolute;">{{$next->account_name}}</span>
                        <a href="{{url('admin/accounts/view/'.$next->id.'/'.$list)}}"
                           class="btn btn-outline-accent m-btn m-btn--icon btn-lg m-btn--icon-only m-btn--pill m-btn--air"><i
                                    class="fa fa-angle-right"></i></a>
                    @endif
                </div>
                ...
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="m-page-title ">
                            <a href="{{ url('/admin/accounts')}}">View Kunden</a> / {{$data->account_name}}
                        </h3>
                    </div>
                </div>
            </div>
            <div class="sub_btn_header col-lg-12">
                <div class="d-flex align-items-center">
                    <div class="mr-auto" style="margin-left: 49%;">
                        @if(Auth::user()->user_role==1)
                            <a href="{{url('admin/accounts/exportAccountDetiledCsv').'/'.$data->id}}"
                               class="btn btn-primary m-btn m-btn--icon" id="export_csv">
            <span>
              <i class="la la-cloud-download"></i>
              <span>
                Export Clients Details
              </span>
            </span>
                            </a>
                        @endif
                        ...
                        @if($edit_kunden=='1')
                            <a href="{{ url('/admin/accounts/edit/'.$data->id )}}" class="btn btn-primary">
                                <span>EDIT</span>
                            </a>
                        @endif
                        @if($delete_kunden=='1')
            ...
            <div class="m-portlet m-portlet--rounded view_block ">
                ...
                <div class="form-group m-form__group row view_data">
                    <div class="col-lg-5">
                        ...
                        <div class="data_accounts">
                            <textarea class="form-control" id="general_notes" name="general_notes" rows=5
                                      style="width: 190%;">{{$data->comments}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="data_accounts col-lg-12" id="touch_rule_checkbox">
                    ...
                    <div class="panel-heading" role="tab" id="headingOne">
                        <div class="panel-title">
                            ...
                            <div class="loader" style='display: block;'>
                                <img src="../../../../assets/app/media/img/logos/loader.gif" width='132px'
                                     height='132px'>
                            </div>
                        </div>
                    </div>
                      ...
                      <span>
                        ...
                        <span>
                          Show Mobile
                                ...
                                <a id="showrule" class="btn m-btn--pill btn-primary">
                      <span>
                        <i class="m-menu__link-icon flaticon-cogwheel-2"></i>
                        <span>
                          7 Touch Rule
                        ...
                        <div class="panel-title">
                            <div class="title_header">
                                <a role="button" data-toggle="collapse" data-parent="#accordion"
                                   href="#detailed_technologies" aria-expanded="true"
                                   aria-controls="detailed_technologies">
                                    <i class="more-less glyphicon glyphicon-plus"></i>
                                    <h4>Detailed Technologies</h4>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div id="detailed_technologies" class="panel-collapse collapse" role="tabpanel"
                         aria-labelledby="headingOne" style="clear:both;">
                        <div class="panel-body">
                            <form id="technolgies_details" method="post">
                                {{ csrf_field() }}
                                @foreach($competences as $competences_val)
                                    <div class="panel panel-default">
                                        ...
                                        <?php $competence_data = explode(',', $data->detailed_technologies);?>
                                            ...
                                            <div class="panel-body">
                                                <div class="m-checkbox-inline">
                                                    @foreach($competences_val->competences_skill as $key => $competences_skill)
                                                        ...
                                                        <label class="m-checkbox">
                                                            <input name="category_rating[]"
                                                                   value="{{$competences_skill->skill}}"
                                                                   type="checkbox" @if(in_array($competences_skill->skill,$competence_data)) {{ 'checked' }} @endif>{{$competences_skill->skill}}
                                                            <span></span>
                                                        </label>
                                                    @endforeach
                                                </div>
                        ...
                        <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                            <div class="m-form__actions m-form__actions--solid">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <button type="submit" id="m_update_technologies" name="m_update_technologies"
                            ...
                            <div class="m-portlet__body">
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-4">
                                        ...
                                        <input type="hidden" value="{{$data->id}}" name="account_id" id="account_id">
                                        <input type="hidden" value="0" name="oppo_type" id="oppo_type">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control m-input"
                                               value="{{$data->client_specification}}" id="hotness" name="hotness"
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" value="{{$data->telephone}}" name="client_number"
                                               ...
                                               placeholder="Enter Client nunber" readonly>
                                        <div class="error_msg">
    ...
    @endsection
    @section('js')
        <script src="{{url('assets/demo/default/custom/components/datatables/base/view-account.js')}}"
                type="text/javascript"></script>
        <script src="{{asset('/js/accounts_script.js')}}" type="text/javascript"></script>
        <script>
            var datatable;
            ...
            (function () {
                ...
                datatable = $('.contact_datatable').mDatatable({
                    ...
                    data: {
                        ...
                        source: {
                            read: {
                                url: '../../../accounts/ContactsDetails/' + id,
                                method: 'GET',
                                // custom headers
                  ...
                  ';
                                ...
                                var knotakte_permission = row.permission ? (row.permission.knotakte_permission || '') : '';
                ...
                $('#showrule').on('click', function () {
                    datatable.showColumn('touch_rule');
                });
            ...
            $('#touch_rule_checkbox input[type=checkbox]').on('click', function () {
                var id = $('#deleteAccount').attr('data-id');
                if (this.checked) {
                    var value = $(this).val();
                    $.ajax({
                        url: '../../accounts/touch_rule_add',
                    ...
                    var value = $(this).val();
                    $.ajax({
                        url: '../../accounts/touch_rule_remove',
                        data: {value: value, id: id},
                        Type: 'GET',
                        success: function (response) {
                        }
