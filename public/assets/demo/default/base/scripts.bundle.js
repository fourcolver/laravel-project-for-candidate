      ...
      filterArray: function(list, args, operator) {
        ...
        var filtered = [];
          ...
          $.each(list, function (key, obj) {
              var to_match = obj;
              console.group('User #'+ obj.user_id);
              var matched = 0;
              $.each(args, function (m_key, m_value) {
                  console.log(m_key, to_match.hasOwnProperty(m_key) && m_value == to_match[m_key], [m_value, to_match[m_key]]);
...
var mLayout = function() {
    ...
    var initQuicksearch = function() {
        ...
        qs.mQuicksearch({
            ...
            source: window.location.href+'/search',
            ...
            templates: {
                error: function(qs) {
                    return '<div class="m-search-results m-search-results--skin-light"><span class="m-search-result__message">No Record Found</div></div>';
                }
            }
        });
    }
