...
MySQL - 5.5.5-10.1.32-MariaDB : Database - argon_strategy
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`argon_strategy` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
insert  into `ag_candidates_invites`(`id`,`email`,`invitation_code`,`created_at`,`sent_at`,`used_at`) values (2,'gux50747@bcaoo.com','9fNXOl5HByBjZcG','2019-06-30 17:13:28','2019-06-30 17:13:28','2019-06-30 17:16:17'),(3,'mariohonegg@gmail.com','5z3itYdxVBMHSylCuN0ofCLETkCB5PuDKn8','2019-07-04 00:23:25','2019-07-04 00:23:25',NULL),(4,'kvt13743@bcaoo.com','YzvcJ90B1ujNpDXUscyJZy05625yqQQy4LW','2019-07-04 01:52:01','2019-07-04 01:52:01',NULL),(5,'sacram@inbox.ru','wIyaBej6JDiqdNZcYLXKUJohlv2eFBJWJAy','2019-07-04 09:26:37','2019-07-04 09:26:37',NULL),(6,'yaa87671@bcaoo.com','NBLnqKFnRkPuAop6M2sv1PwmkdASupo1TMp','2019-07-04 09:31:35','2019-07-04 09:31:35',NULL),(7,'work.a.andrey@gmail.com','AO3fZXIBuB0UpUY4Vw31HXWD8L08SLYMzUj','2019-07-04 09:32:55','2019-07-04 09:32:55',NULL);
...
insert  into `ag_competences`(`id`,`name`) values (1,'Microsoft .Net'),(2,'Embedded'),(3,'Java'),(4,'Network Security Infrastructure'),(5,'SAP'),(6,'Testing'),(7,'Business Intelligence'),(8,'Project management');
...
/*Table structure for table `ag_education` */

DROP TABLE IF EXISTS `ag_education`;

CREATE TABLE `ag_education` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `kandidate_id` int(11) NOT NULL,
  `graduation` varchar(512) DEFAULT NULL,
  `training_facility` int(11) DEFAULT NULL,
  `education_start` varchar(216) DEFAULT NULL,
  `education_end` varchar(216) DEFAULT NULL,
  `description` varchar(512) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=latin1;

/*Data for the table `ag_education` */

insert  into `ag_education`(`id`,`kandidate_id`,`graduation`,`training_facility`,`education_start`,`education_end`,`description`) values (1,10,'oxford',5,'03/2003','11/2009','it was awesome with this university.....'),(3,12,'Krasnodar',2,'03/2003','09/2009','Amazing'),(4,13,'krasnodar',2,'03/2003','09/2009','very quick day'),(18,17,'OXFORD',2,'03/2003','09/2009','Very recommanded.'),(19,12,'Havard',3,'03/2003','09/2009','Nice memory with this University'),(20,10,'Singapore',5,'01/2019','10/2019','Hello. Uinversity'),(21,10,'f',6,'05/2019','11/2019','ff');
...
insert  into `ag_emp_permission`(`id`,`emp_id`,`emp_index`,`emp_view`,`kunden_permission`,`knotakte_permission`,`kandidaten_permission`,`festanstellung_permission`,`projektanfrage_permission`,`task_permission`,`created_at`,`updated_at`,`status`) values (1,'2','index','view',NULL,NULL,NULL,NULL,NULL,NULL,'2018-11-05 02:01:04','2018-11-05 02:01:04',1),(2,'5','index','view',NULL,NULL,NULL,NULL,NULL,NULL,'2018-11-17 03:54:18','2018-11-17 03:54:18',1);
...
insert  into `ag_goal_setby_users`(`id`,`set_by`,`client_activity`,`client_add`,`candidate_add`,`oppo_add`,`status`) values (1,'1','33',NULL,'4',NULL,1),(2,'5','5','7','33','0',1),(3,'2','15','6','7','8',1);
...
insert  into `ag_migrations`(`id`,`migration`,`batch`) values (1,'2018_10_31_110126_UsersAddPrimaryKey',1),(2,'2018_10_31_110126_CompetencesAddPrimaryKey',2),(3,'2018_10_31_110126_EmpPermissionAddPrimaryKey',2);
...
insert  into `ag_password_resets`(`email`,`token`,`created_at`) values ('jan.guhl@summitize.com','$2y$10$oyCT1BwxUn4XH2D8BxTsW.fMgnocfNBAOoc0uKDgVR8eXE9MoCZ3y','2018-11-29 03:34:28'),('work.a.andrey@gmail.com','$2y$10$988nUxehQsOOqq117sQ8Pu6giiznodb.jTI1tePLRSA0JGZ3Lk1me','2018-11-29 21:48:48');
...
insert  into `ag_user_todolist`(`id`,`user_id`,`comments`) values (1,7,NULL);
...
insert  into `ag_users`(`id`,`title`,`first_name`,`middle_name`,`last_name`,`email`,`password`,`Mobile`,`home_number`,`admin_doc`,`user_profile`,`user_role`,`added_by`,`remember_token`,`created_at`,`updated_at`,`postal_code`,`status`,`number`) values (1,'Herr','SEBASTIAN','','argon','admin@argon-strategy.com','$2y$10$.xz6z6csp2zpikkuJhYMzuZH4agyGLI6QwcOLzDUzFRUe8KPIEzxa',NULL,NULL,NULL,NULL,'1',1,'0AUjoGqpGB5Ukb2L7p5gwzZn9sydQ8X85kZSrymCmHHTllAiOPI36aCoKwOq','2018-11-05 01:31:35','2019-04-08 00:21:56',NULL,1,1),(2,'Herr','Andrey','','Artyushenko','work.a.andrey@gmail.com','$2y$10$7Xmmpg7MYShmpdrV8ojRv.oSbE/AU0EIW01T/Jz0MsgXIR6rBIfFm',NULL,NULL,NULL,NULL,'1',1,'YHMYVIYCA5J9q3HaTii5UTnq10uY8iljQl6Yhvk4MYLsoeIbjpU18nXsRC94','2018-11-05 01:31:35','2018-11-05 01:33:56',NULL,1,2),(3,'Herr','Andrey','V','Artyushenko','rzd03509@iencm.com','$2y$10$WHeRnHQIDG7hnoh.EwK61uWowJ3tZqQFZT8IQ3D8MXsNmdSLP65V6',NULL,NULL,NULL,NULL,'0',1,'naTq7OvXXGUkib5V6rhSBB9bHzFLa88JvWmA8WT8ZsCHWCYCYdkZdxVDwq0V','2018-11-05 01:36:13','2018-11-05 01:36:13',NULL,1,3),(4,'Herr','Mario',NULL,'Honegg','mariohonegg@gmail.com','$2y$10$8dEzfRksh5e/XPZgXUf9/.J447u.AmAxJULSIbh6le1gGjCcd/WL.','07127','07127',NULL,NULL,'0',1,NULL,'2018-11-08 04:36:01','2018-11-08 04:36:01','12345',1,4),(5,'Herr','John',NULL,'Doe','john.doe@email.com','$2y$10$3WDBaUL8CptC7PMzEd6MKeXDtYnIx.QEXQ7i48IkWw3sHVTRP6m0i',NULL,NULL,NULL,NULL,'2',1,NULL,NULL,NULL,NULL,1,5),(6,'Herr','Jan','S.','Guhl','jan.guhl@summitize.com','$2y$10$t0fFsaDfj91wXNo/HQ4LHeooTyJLBibVEC0YrpIrXaFrsyK7b3u8K',NULL,NULL,NULL,NULL,'0',1,NULL,'2018-11-29 03:32:29','2018-11-29 03:32:29',NULL,1,6),(7,'Herr','John','','Doe','kunden@argonstrategy.com','$2y$10$zHHCEO./T3gpxi1hhxvhNeDZ4DFGGY5OChFOMeKWhjHY6MkQ8/f7m',NULL,NULL,NULL,NULL,'0',1,'HLdCgl0B75FCO1xPz7p6busW8aGWxqtOLfiOgoHXDGcWa4Iaeru5IR8MYQGf','2018-11-05 01:31:35','2019-03-18 20:53:23',NULL,1,7),(8,'Herr','BgtLYbnpPJNy','yMCHSFiLvzgr','ixNneMZIzOFh','hopurringpo@gmail.com','$2y$10$/U.YyJMPysTEFZVUun.e/.nPtGO9UC.PUHCNpNkvm/KickHNXZIZ6',NULL,NULL,NULL,NULL,'0',1,NULL,'2019-08-24 08:20:15','2019-08-24 08:20:15',NULL,1,NULL),(9,'Herr','HxysPmXMSvFE','HYagtUVmRNDz','QkeZzhqObvFK','dinahfletcher3133@gmail.com','$2y$10$Eur81ocuxtCBXT8Io6apMeO3gWMOYeKn2W3r08r63ePSQkldCgg..',NULL,NULL,NULL,NULL,'0',1,NULL,'2019-08-27 22:32:42','2019-08-27 22:32:42',NULL,1,NULL);
...
/*Table structure for table `ag_work_experience` */

DROP TABLE IF EXISTS `ag_work_experience`;

CREATE TABLE `ag_work_experience` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `kandidate_id` int(11) NOT NULL,
  `experience_sector` int(11) DEFAULT NULL,
  `experience_start` varchar(256) DEFAULT NULL,
  `experience_end` varchar(256) DEFAULT NULL,
  `experience_company` varchar(512) DEFAULT NULL,
  `experience_postion` int(11) DEFAULT NULL,
  `experience_description` varchar(512) DEFAULT NULL,
  `skills_with_work` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=latin1;

/*Data for the table `ag_work_experience` */

insert  into `ag_work_experience`(`id`,`kandidate_id`,`experience_sector`,`experience_start`,`experience_end`,`experience_company`,`experience_postion`,`experience_description`,`skills_with_work`) values (3,10,5,'03/2003','03/2003','Soap',1,'Worked with good realationship','2,5,6'),(5,12,1,'03/2003','03/2003','samsung',5,'Very good job.',NULL),(6,12,5,'03/2003','03/2003','LG',7,'Highly recommended.',NULL),(9,10,2,'03/2003','03/2003','shopcom',1,'Very nice job','2,4,6,8,20'),(10,14,2,'03/2003','03/2003','tttttyyyy',1,'erer',NULL),(12,17,5,'03/2003','03/2003','LG with',1,'This is very nice company.',NULL),(13,12,6,'03/2003','03/2003','LG',3,'I worked in this company about 4 years.',NULL),(15,10,18,'01/2019','02/2019','trt',2,'ttt','2,4,6,8,22'),(16,10,1,'06/2019','11/2019','ttt',1,'tttt','2,6');

/*Table structure for table `ag_work_experience_skills` */

DROP TABLE IF EXISTS `ag_work_experience_skills`;

CREATE TABLE `ag_work_experience_skills` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `kandidate` int(11) NOT NULL,
  `skill_with_work` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

/*Data for the table `ag_work_experience_skills` */

insert  into `ag_work_experience_skills`(`id`,`kandidate`,`skill_with_work`) values (1,10,'2,4,6,8,20'),(2,10,'2,5,6,9');
